...
releaseDir='/cvmfs/sw.hsf.org/key4hep'
ddsimDir='~/GIT/DualIanna'
k4recDir='~/GIT/k4RecCalorimeter'
...
argParser.add_argument('-n','--dryrun', action="store_true", default=False, help='generate script(s), but do not submit jobs')
...
beamOrigin="0. 0.*mm -80*cm"  # default
if args.origin=="1" :
    beamOrigin="0. -7*mm -1*mm"
if args.origin=="2" :
    beamOrigin="-22*mm -22*mm -80*cm"
...
source {ddsimDir}/install/bin/thisDualIanna.sh 
cd {k4recDir} ; k4_local_repo ; cd -
cd {ddsimDir}/compact
